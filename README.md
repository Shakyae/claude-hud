...
```
/plugin marketplace add Shakyae/claude-hud
```
...
```bash
git clone https://github.com/Shakyae/claude-hud
cd claude-hud
...
[![Star History Chart](https://api.star-history.com/svg?repos=Shakyae/claude-hud&type=Date)](https://star-history.com/#Shakyae/claude-hud&Date)
